...
<link rel = 'stylesheet' href = 'styles.css'>
	...
	?>
        ...
        <thead>
					...
					<tbody>
					<?php
						$query = mysql_query("SELECT Id, PhotoReqs, Title,Photographer FROM articles WHERE Volume = '$volume' and Issue = $issue and PhotoReqs != '0' and PhotoReqs != ''") or die(mysql_error());
						while ($photo = mysql_fetch_array($query)){
							echo '<tr>';
							
							echo '<td  width="20%">';
							echo '<a href="edit.php?id=' . $photo['Id'] . '">' . $photo['Title'] . '</a>';
							echo '</td>';
							echo '<td width = "15%">' . $photo["Photographer"] .'</td>';
							echo '<td width="65%">';
							echo $photo['PhotoReqs'];
							echo '</td>';
							echo '</tr>';
						}
					?>
