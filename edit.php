		...
		?>
			...
			<?php if($role == 'Admin' || $role == 'Senior Staff' || $role = 'Senior Editor'){?>
					...
					<select name="section" id="section">
					 ...
					 &nbsp; &nbsp;
				<input type="text" name="duedate" id="duedate" value="<?=$row['DueDate']?>" class = "field span2" placeholder = "Due date"/>   &nbsp; &nbsp;
				
				
				
			<input type="text" class = "field span1" name="volume" id="volume"  value = <?=$row['Volume']?> size="1" />
				-
				<input type="text" class = "field span1" name="issue" id="issue"  value=<?=$row['Issue']?> size="1" />
			...
			echo '<input type="hidden" name="section" id="section" value="$section"/>';
				...
				echo '<input type="hidden" name="volume" id="volume"  value =' . $row['Volume'] .'size="1" />
				-
			...
			<div class = "row-fluid">
				...
				if($editid > 7390 || $row['Status']== 'Unwritten') {
				
				echo '<link rel="stylesheet" href="../cfs2/ckeditor/contents.css">'; 
				}
				?>
				<textarea <?php if($editid > 7300 || $row['Status']== 'Unwritten') { echo "class = 'ckeditor'";} else echo 'class = "field span12"'; ?> rows = "20" name="article" id="article"  placeholder = "Write your article here!"><?=$article?></textarea>
				<link href="../cfs2/bootstrap/css/bootstrap.css" rel="stylesheet">
				</div>
			...
			<span class = "span9">
				<label for="photoreqs"></label>
				<textarea  class = "field span11" name="photoreqs" id="photoreqs" placeholder = "Photo/Graphic Request" rows="5" cols="100"><?=$row['PhotoReqs']?></textarea>
